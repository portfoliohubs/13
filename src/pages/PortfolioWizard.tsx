            ...
            {currentStep === 'contact' && (
              <section className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <InputField label="Instagram" value={form.instagram} onChange={v => set('instagram', v)} placeholder="https://www.instagram.com/yourhandle" type="url" />
                    <InputField label="Facebook" value={form.facebook} onChange={v => set('facebook', v)} placeholder="https://www.facebook.com/yourpage" type="url" />
                    <div className="sm:col-span-2">
                      <InputField label="LinkedIn" value={form.linkedin} onChange={v => set('linkedin', v)} placeholder="https://linkedin.com/in/yourprofile" type="url" />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <InputField label="Latitude" value={form.locationLat} onChange={v => set('locationLat', v)} placeholder="e.g. 30.585070" />
                    <InputField label="Longitude" value={form.locationLng} onChange={v => set('locationLng', v)} placeholder="e.g. 31.487296" />
                  </div>
                </div>
              </section>
            )}
